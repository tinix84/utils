...
PARAMS = [
    {"name": "R1", "init":      100, "vary": True, "min": 1e-12, "max": None},
    {"name": "C1", "init":  200e-12, "vary": True, "min": 1e-12, "max": None},
    {"name": "R2", "init":      100, "vary": True, "min": 1e-12, "max": None},
    {"name": "C2", "init":  200e-12, "vary": True, "min": 1e-12, "max": None},
    {"name": "L2", "init":    10e-6, "vary": True, "min": 1e-12, "max": None},
    {"name": "R3", "init":     20.0, "vary": True, "min": 1e-12, "max": None},
    {"name": "C3", "init":  300e-12, "vary": True, "min": 1e-12, "max": None},
    {"name": "L3", "init":    10e-6, "vary": True, "min": 1e-12, "max": None},
]
