...
PARAMS = [
    {"name":    "C", "init": 10.0e-12, "vary": True, "min": 1e-12, "max":  1.00e12},
    {"name":    "L", "init":  40.0e-6, "vary": True, "min":  1e-12, "max":  50.0e-6},
    {"name": "Rldc", "init":  20.0e-3, "vary": True, "min":  1e-12, "max":     2.00},
    {"name":   "sf", "init":  1.00e-6, "vary": True, "min":  1e-12, "max":  1.00e12},
]
